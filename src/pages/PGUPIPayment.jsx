    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="bg-indigo-600 p-6 text-white">
          <h1 className="text-2xl font-bold text-center">PG UPI Payment</h1>
          ...
          <div className="flex flex-col items-center">
            {isMobile ? (
              <button
                ...
                className="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-lg text-lg font-medium flex items-center gap-2 transition-colors"
              >
                <FiExternalLink />
                Open UPI App
              </button>
              ...
              qrImage && (
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-gray-600 text-sm mb-2">Scan this QR with any UPI app</p>
                </div>
              )
            )}
          </div>
        ...
        <div className="p-6">
          ...
          <p className="mt-4 text-sm text-gray-600 text-center">
            Trouble paying?{" "}
            <a href={upiUrl} className="text-indigo-600 hover:underline">
              Try manual payment
            </a>
          </p>
        </div>
